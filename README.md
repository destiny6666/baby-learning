...
- 英语六个主题各 25 张词卡（共 150 张），选学区直接展开，学习报告在底部；新增词汇及短句均有录音。
- 手机底部四个入口，游戏大全可进入全部八个模块；每个模块首页可直接开始或继续任务。
- 数学加减与凑数提供可重播的实物动画，轻松凑数轮换 3、4、5。
- 记忆配对每轮累计 10 对，每成功一对即保存进度，可中途休息。
- 闯关冒险进入每道题自动朗读，也可点“听题目”重听；离开题卡即停止。
