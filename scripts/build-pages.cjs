...
const files=['index.html','learning.css','life-play.css','speech-catalog.js','speech-player.js','practice.js','learning.js','logic-play.js','enrichment.js','logic-hub.js','life-play.js'];
