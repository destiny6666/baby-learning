var LOGIC_ACTIVITIES=[
  ...
  {id:'memory',title:'记忆配对',category:'记住位置',icon:'🧠',key:'logic_memory',setting:'memoryLevel',description:'一次翻两张，找出相同的图形小伙伴。',detail:'翻过的图案，要记住在哪里哦',levels:['3对图片','4对图片','5对图片'],color:'mint'}
];
